...
/*
    ...
    function load_p4m_video(nav_html, inner_html) {
        ...
        inner_html += '</div><br/>';
        inner_html += 
            '<p>4천 년 전 이삭과 이스마엘 형제 갈등이 역사적으로 팽창하여 지구적 갈등이 되었고, 9.11 사태 이후 세계는 종교 갈등으로 곤두박질하고 있습니다. 또한, 전 세계를 충격과 공포로 몰아넣은 ISIS의 출현과 더불어 시리아에서는 멈추지 않는 내전과 테러로 인해 천만에 달하는 난민이 쏟아져 나오고 있습니다. 이러한 가운데서도 천국 복음은 모든 민족을 향하여 빠르게 전파되어지고 있으며 어둠의 세력은 그 어느 때 보다 강력하게 저항하고 있습니다.' +
            '이슬람은 전 세계 70억 인구 중 17억으로 그 세력이 확장되었습니다. 이들은 매년 한 달 간, 해가 뜰 때부터 질 때까지 금식하며 기도하는 \'라마단\'을 지키면서, 이슬람으로 연대하며 정체성을 회복하고, 행위를 통해 구원을 얻고자 애씁니다.</p>' +
